...
from layers.LGMixer import LGMixer
import torch
...
class AttentionMixer(nn.Module):
    ...
    def forward(self, *attns):
        ...
        alpha = F.sigmoid(self.raw_alpha)
...
class EncoderLayer(nn.Module):
    ...
    def forward(self, x, attn_mask=None, tau=None, delta=None):
        ...
        y = x = self.norm1(x)
        y = self.dropout(self.mixer1(x))
        y = self.dropout(y)
        
        return self.norm2(self.mixer2(x+y)), attn
...
class DecoderLayer(nn.Module):
    ...
    def forward(self, x, cross, x_mask=None, cross_mask=None, tau=None, delta=None):
        ...
        x = self.mixer(x,self.dropout(self.cross_attention(
            x, cross, cross,
        ...
        return self.norm3(self.mixer(x,y))
